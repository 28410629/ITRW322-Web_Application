...
- [x] Still images;
- [x] Video;
- [x] Non-streaming audio, such as FLAC, AAC, or MP3;
...
- [ ] [25]:  The  application  has real-time video  chat  capabilities,  i.e.  it  can  be  used  to hold  a  coherent conversation between at least two peoplein real-time.
